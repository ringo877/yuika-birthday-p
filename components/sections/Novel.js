          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ${Object.values(StoryGenre).map((genre) => html`
                  <button
                    key=${genre}
            ...
            >
              ${loading ? html`
                <div className="flex items-center gap-2">
                   ...
                   <span className="text-xs animate-pulse">${loadingText}</span>
                </div>
              ` : html`
            ...
            <p className="text-[10px] text-gray-400 text-center mt-2">※AIが一生懸命考えるため、1分ほどかかることがあります</p>
          </div>
        </div>
